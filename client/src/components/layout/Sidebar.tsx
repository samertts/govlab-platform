    ...
    <div className="flex flex-col h-full bg-slate-900 text-slate-100">
      <div className="p-6 border-b border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold font-display tracking-tight text-white">GovLab LIS</h1>
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="bg-slate-800/50 rounded-xl p-4">
          ...
          <p className="text-xs text-slate-400 uppercase tracking-wider mt-0.5">{user?.role}</p>
          <Button 
            variant="ghost" 
            size="sm" 
            className="w-full mt-3 justify-start text-red-400 hover:text-red-300 hover:bg-red-950/30"
            onClick={() => logout()}
          >
